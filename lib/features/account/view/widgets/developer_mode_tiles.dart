        ...
        _buildActionRow(
          ...
          onTap: () async {
            try {
              ...
              ref.read(analyticsServiceProvider).logEvent(AnalyticsEvents.forceSessionRefresh);
            } catch (e) {
              if (context.mounted) {
          ...
          TextButton(
            onPressed: () async {
              ...
              try {
                ...
                ref.read(analyticsServiceProvider).logEvent(AnalyticsEvents.clearAllLocalData);
              } catch (e) {
                if (context.mounted) {
