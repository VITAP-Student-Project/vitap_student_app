...
class _WeekendOutingTabState extends ConsumerState<WeekendOutingTab> {
  ...
  Future<void> _refreshData() async {
    await AnalyticsService.logEvent('refresh_weekend_outing');
    setState(() {
  ...
  Widget build(BuildContext context) {
    final outingReportsState = ref.watch(weekendOutingReportsViewModelProvider);
        ...
        slivers: [
          ...
          outingReportsState?.when(
                  ...
                  if (reports.isEmpty) {
                    return const SliverFillRemaining(
                      child: EmptyContentView(
                        ...
                        secondaryText: 'No weekend outing reports found',
                      ),
                    );
                  }
                  ...
                  return SliverList.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: WeekendOutingCard(outing: reports[index]),
                      );
                    },
                  );
                },
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          'Failed to load weekend outings',
                          style:
              ...
              const SliverFillRemaining(
                child: EmptyContentView(
                  primaryText: 'Weekend Outings',
                  secondaryText:
                      'Pull to refresh and load your weekend outing reports',
                ),
              ),
        ],
      ),
