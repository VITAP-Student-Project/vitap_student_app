...
// These functions are ignored because they are not marked as `pub`: `extract_captcha_data`, `extract_csrf_token`, `get_login_page_error`, `get_regno`, `handle_session_check`, `load_initial_page`, `load_login_page`, `make_client`, `perform_login`
