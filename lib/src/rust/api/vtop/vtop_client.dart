...
import 'types/general_outing.dart';
...
abstract class VtopClient implements RustOpaqueInterface {
  ...
  /// # }
  /// ```
  Future<Uint8List> downloadAllCourseMaterials({required String downloadPath});
  ...
  Future<List<GetFaculty>> getAllFaculty();
  ...
  /// # }
  /// ```
  Future<CoursesResponse> getCoursesForCoursePage({required String semesterId});
  ...
  /// # }
  /// ```
  Future<FacultyDetails> getFacultyData({required String empId});
  ...
  /// # }
  /// ```
  Future<List<GeneralOutingRecord>> getGeneralOutingReports();
  ...
  /// # }
  /// ```
  Future<GradeHistory> getGradeHistory();
  ...
  /// # }
  /// ```
  Future<List<PaidPaymentReceipt>> getPaymentReceipts();
  ...
  /// # }
  /// ```
  Future<List<PendingPaymentReceipt>> getPendingPayment();
  ...
  /// # }
  /// ```
  Future<List<WeekendOutingRecord>> getWeekendOutingReports();
  ...
  /// - `SessionExpired` → missing CSRF/session token
  Future<void> verifyLoginOtp({required String otp});
