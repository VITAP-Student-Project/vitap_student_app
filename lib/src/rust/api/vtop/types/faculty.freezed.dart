...
mixin _$FacultyDetails {
  ...
  String get schoolCentre;
  String get email;
  String get cabinNumber;
  List<OfficeHour> get officeHours;

  /// Create a copy of FacultyDetails
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FacultyDetailsCopyWith<FacultyDetails> get copyWith =>
      _$FacultyDetailsCopyWithImpl<FacultyDetails>(
          this as FacultyDetails, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FacultyDetails &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.designation, designation) ||
                other.designation == designation) &&
            (identical(other.department, department) ||
                other.department == department) &&
            (identical(other.schoolCentre, schoolCentre) ||
                other.schoolCentre == schoolCentre) &&
...
abstract mixin class $FacultyDetailsCopyWith<$Res> {
  factory $FacultyDetailsCopyWith(
          FacultyDetails value, $Res Function(FacultyDetails) _then) =
      _$FacultyDetailsCopyWithImpl;
  @useResult
  $Res call(
      {String name,
      String designation,
    ...
    return _then(_self.copyWith(
      ...
      department: null == department
          ...
          : department // ignore: cast_nullable_to_non_nullable
              as String,
      schoolCentre: null == schoolCentre
          ? _self.schoolCentre
          : schoolCentre // ignore: cast_nullable_to_non_nullable
              as String,
      email: null == email
          ? _self.email
...
extension FacultyDetailsPatterns on FacultyDetails {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FacultyDetails value)? $default, {
...
class _FacultyDetails implements FacultyDetails {
  const _FacultyDetails(
      ...
      required final List<OfficeHour> officeHours})
      : _officeHours = officeHours;
  factory _FacultyDetails.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FacultyDetailsCopyWith<_FacultyDetails> get copyWith =>
      __$FacultyDetailsCopyWithImpl<_FacultyDetails>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FacultyDetailsToJson(
      this,
    );
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.cabinNumber, cabinNumber) ||
                other.cabinNumber == cabinNumber) &&
            const DeepCollectionEquality()
                .equals(other._officeHours, _officeHours));
  }
  ...
  int get hashCode => Object.hash(
      ...
      email,
      cabinNumber,
      const DeepCollectionEquality().hash(_officeHours));
...
/// @nodoc
abstract mixin class _$FacultyDetailsCopyWith<$Res>
    implements $FacultyDetailsCopyWith<$Res> {
  factory _$FacultyDetailsCopyWith(
          _FacultyDetails value, $Res Function(_FacultyDetails) _then) =
      __$FacultyDetailsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String name,
...
mixin _$GetFaculty {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $GetFacultyCopyWith<GetFaculty> get copyWith =>
      _$GetFacultyCopyWithImpl<GetFaculty>(this as GetFaculty, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.designation, designation) ||
                other.designation == designation) &&
            (identical(other.schoolOrCentre, schoolOrCentre) ||
                other.schoolOrCentre == schoolOrCentre) &&
            (identical(other.empId, empId) || other.empId == empId));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, facultyName, designation, schoolOrCentre, empId);
...
abstract mixin class $GetFacultyCopyWith<$Res> {
  factory $GetFacultyCopyWith(
          GetFaculty value, $Res Function(GetFaculty) _then) =
      _$GetFacultyCopyWithImpl;
  @useResult
  $Res call(
      {String facultyName,
      String designation,
      String schoolOrCentre,
      String empId});
}

/// @nodoc
class _$GetFacultyCopyWithImpl<$Res> implements $GetFacultyCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      ...
      designation: null == designation
          ...
          : designation // ignore: cast_nullable_to_non_nullable
              as String,
      schoolOrCentre: null == schoolOrCentre
          ? _self.schoolOrCentre
          : schoolOrCentre // ignore: cast_nullable_to_non_nullable
              as String,
      empId: null == empId
          ? _self.empId
...
extension GetFacultyPatterns on GetFaculty {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GetFaculty value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String facultyName, String designation,
            String schoolOrCentre, String empId)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _GetFaculty() when $default != null:
        return $default(_that.facultyName, _that.designation,
            _that.schoolOrCentre, _that.empId);
      case _:
        return orElse();
    }
  }
...
class _GetFaculty implements GetFaculty {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GetFacultyCopyWith<_GetFaculty> get copyWith =>
      __$GetFacultyCopyWithImpl<_GetFaculty>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GetFaculty &&
            (identical(other.facultyName, facultyName) ||
                other.facultyName == facultyName) &&
            (identical(other.designation, designation) ||
                other.designation == designation) &&
...
/// @nodoc
abstract mixin class _$GetFacultyCopyWith<$Res>
    implements $GetFacultyCopyWith<$Res> {
  factory _$GetFacultyCopyWith(
          _GetFaculty value, $Res Function(_GetFaculty) _then) =
      __$GetFacultyCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String facultyName,
...
/// @nodoc
class __$GetFacultyCopyWithImpl<$Res> implements _$GetFacultyCopyWith<$Res> {
...
mixin _$OfficeHour {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $OfficeHourCopyWith<OfficeHour> get copyWith =>
      _$OfficeHourCopyWithImpl<OfficeHour>(this as OfficeHour, _$identity);
...
abstract mixin class $OfficeHourCopyWith<$Res> {
  factory $OfficeHourCopyWith(
          OfficeHour value, $Res Function(OfficeHour) _then) =
      _$OfficeHourCopyWithImpl;
  @useResult
  $Res call({String day, String timings});
}

/// @nodoc
class _$OfficeHourCopyWithImpl<$Res> implements $OfficeHourCopyWith<$Res> {
...
extension OfficeHourPatterns on OfficeHour {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_OfficeHour value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String day, String timings)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _OfficeHour implements OfficeHour {
  ...
  factory _OfficeHour.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$OfficeHourCopyWith<_OfficeHour> get copyWith =>
      __$OfficeHourCopyWithImpl<_OfficeHour>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$OfficeHourToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$OfficeHourCopyWith<$Res>
    implements $OfficeHourCopyWith<$Res> {
  factory _$OfficeHourCopyWith(
          _OfficeHour value, $Res Function(_OfficeHour) _then) =
      __$OfficeHourCopyWithImpl;
  @override
  @useResult
  $Res call({String day, String timings});
}
...
/// @nodoc
class __$OfficeHourCopyWithImpl<$Res> implements _$OfficeHourCopyWith<$Res> {
